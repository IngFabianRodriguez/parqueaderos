...
class Settings(BaseSettings):
    ...
    kafka_group_id: str = "billing-service-group"
    ...
    otel_service_name: str = "billing-service"
    ...
    dian_api_url: str = "https://api.dian.gov.co"
    dian_client_id: str = ""
    dian_client_secret: str = ""
    dian_env: Literal["production", "test"] = "test"
